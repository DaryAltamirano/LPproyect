...
<div class= "container">
    <div class = "row ">
        <div class= "col text-left">
            ...
            <b-button size="sm" :to="{name:'newdesaparecido'}" variant="primary">Nuevo desaparecido </b-button>
            </div>
            <br>
            <div class="col-md-12">
                <b-table striped hover :items= "desaparecidos" :fields="fields">
                <template v-slot:cell(action)="data">
                    <b-button size="sm" variant="primary" :to="{name:'editdesaparecido',params:{desaparecidoId:data.item.id}}">Editar</b-button>
                     <b-button size="sm" variant="danger" :to="{name:'deledesaparecido',params:{desaparecidoId:data.item.id}}">Eliminar</b-button>
                </template>
                </b-table>
            </div>
        </div>
